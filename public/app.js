...
const PROSPECT_UPDATES={
  ...
  'Treydan Stukes':{delta:3,source:'Jeremiah final mock #29 to KC. 4.33 forty, 38" vert. Scouts comp him to Trent McDuffie. "Very impressive in interviews."',date:'2026-04-22'},
  'Chris Johnson':{delta:2,source:'Jeremiah final mock #31 to NE. Hyperaware coverage specialist with 92.4 PFF coverage grade and 16.1 passer rating allowed.',date:'2026-04-22'},
  'Spencer Fano':{delta:2,source:'Jeremiah has him #6 to CLE over Kadyn Proctor — "more athletic and consistent offensive lineman."',date:'2026-04-22'},
  'Peter Woods':{delta:2,source:'Jeremiah has BAL trading UP to #32 for Woods (insurance for Madubuike neck surgery recovery).',date:'2026-04-22'},
  'Blake Miller':{delta:2,source:'Jeremiah #21 to PIT — "Broderick Jones limited, Fautanu moves to LT, Miller slides in at RT."',date:'2026-04-22'},
  'Akheem Mesidor':{delta:1,source:'Jeremiah #23 to TB (traded down from PHI). "Productive rusher with inside/outside versatility."',date:'2026-04-22'},
  'Keldric Faulk':{delta:1,source:'Jeremiah #25 to BUF. "Good scheme fit for Dennis Allen — edge AND inside rush ability."',date:'2026-04-22'},
  'Caleb Lomu':{delta:1,source:'Jeremiah #30 to MIA (from DEN via trade). Pairs with Patrick Paul to give Miami young bookends.',date:'2026-04-22'},
  'Olaivavega Ioane':{delta:2,source:'Jeremiah #22 to LAC — "dream scenario, fills biggest roster need, immediately thrives in McDaniel\'s offense."',date:'2026-04-22'},
  'Denzel Boston':{delta:1,source:'Jeremiah #27 to SF. "Comes highly recommended out of Washington\'s program."',date:'2026-04-22'},
};
...
// ===== 32 NFL TEAMS =====
// Needs ordered by expert-projected priority (Jeremiah final mock + B/R consensus, Apr 22).
// tendency.tradeUp reflects actual pre-draft rumors (e.g. NO, PHI, ARI, BAL rumored to move up).
const TEAMS=[
  {abbr:'LV',name:'Las Vegas Raiders',color:'#a5acaf',needs:['QB','OL','WR','CB','EDGE'],
   tendency:{bpa:0.3,posPrefs:['QB','WR'],conf:'Big Ten',tradeUp:false}},
  ...
  {abbr:'ARI',name:'Arizona Cardinals',color:'#97233f',needs:['OT','QB','EDGE','OL','S'],
   tendency:{bpa:0.5,posPrefs:['OT','QB'],conf:'SEC',tradeUp:true}},
  ...
  {abbr:'NYG',name:'New York Giants',color:'#0b2265',needs:['RB','WR','DB','OL','EDGE'],
   tendency:{bpa:0.4,posPrefs:['RB','WR'],conf:'Big Ten',tradeUp:false}},
  {abbr:'CLE',name:'Cleveland Browns',color:'#311d00',needs:['OT','WR','QB','EDGE','CB'],
   tendency:{bpa:0.5,posPrefs:['OT','WR'],conf:'Big 12',tradeUp:true}},
  {abbr:'WAS',name:'Washington Commanders',color:'#5a1414',needs:['WR','S','OL','EDGE','CB'],
   tendency:{bpa:0.5,posPrefs:['WR','S'],conf:'Big 12',tradeUp:false}},
  {abbr:'NO',name:'New Orleans Saints',color:'#d3bc8d',needs:['EDGE','OL','CB','WR','DL'],
   tendency:{bpa:0.4,posPrefs:['EDGE','CB'],conf:'Big Ten',tradeUp:true}},
  {abbr:'KC',name:'Kansas City Chiefs',color:'#e31837',needs:['CB','OT','DT','DB','WR'],
   tendency:{bpa:0.6,posPrefs:['CB','OT'],conf:'SEC',tradeUp:false}},
  {abbr:'CIN',name:'Cincinnati Bengals',color:'#fb4f14',needs:['EDGE','OL','DL','CB','LB'],
   tendency:{bpa:0.5,posPrefs:['EDGE','OL'],conf:'Big Ten',tradeUp:false}},
  {abbr:'MIA',name:'Miami Dolphins',color:'#008e97',needs:['EDGE','OT','OL','S','LB'],
   tendency:{bpa:0.5,posPrefs:['EDGE','OT'],conf:'ACC',tradeUp:true}},
  {abbr:'DAL',name:'Dallas Cowboys',color:'#003594',needs:['S','EDGE','WR','CB','OL'],
   tendency:{bpa:0.5,posPrefs:['S','EDGE'],conf:'Big Ten',tradeUp:true}},
  {abbr:'ATL',name:'Atlanta Falcons',color:'#a71930',needs:['EDGE','DL','OL','S','CB'],
   tendency:{bpa:0.4,posPrefs:['EDGE','CB'],conf:'SEC',tradeUp:true}},
  {abbr:'BAL',name:'Baltimore Ravens',color:'#241773',needs:['TE','IOL','WR','CB','DT'],
   tendency:{bpa:0.7,posPrefs:['TE','IOL'],conf:'Big Ten',tradeUp:true}},
  {abbr:'TB',name:'Tampa Bay Buccaneers',color:'#d50a0a',needs:['OT','EDGE','DL','S','CB'],
   tendency:{bpa:0.5,posPrefs:['OT','EDGE'],conf:'SEC',tradeUp:false}},
  ...
  {abbr:'DET',name:'Detroit Lions',color:'#0076b6',needs:['OT','CB','EDGE','DL','S'],
   tendency:{bpa:0.6,posPrefs:['OT','EDGE'],conf:'SEC',tradeUp:false}},
  {abbr:'MIN',name:'Minnesota Vikings',color:'#4f2683',needs:['CB','OL','EDGE','S','DL'],
   tendency:{bpa:0.5,posPrefs:['CB','OL'],conf:'SEC',tradeUp:false}},
  {abbr:'CAR',name:'Carolina Panthers',color:'#0085ca',needs:['S','OL','WR','EDGE','DL'],
   tendency:{bpa:0.5,posPrefs:['S','DL'],conf:'Big Ten',tradeUp:false}},
  {abbr:'GB',name:'Green Bay Packers',color:'#203731',needs:['DL','EDGE','WR','S','CB'],
   tendency:{bpa:0.7,posPrefs:['DL','EDGE'],conf:'Big Ten',tradeUp:false}},
  {abbr:'PIT',name:'Pittsburgh Steelers',color:'#ffb612',needs:['OT','WR','CB','EDGE','DL'],
   tendency:{bpa:0.5,posPrefs:['OT','WR'],conf:'ACC',tradeUp:false}},
  {abbr:'LAC',name:'Los Angeles Chargers',color:'#0080c6',needs:['IOL','EDGE','WR','DL','CB'],
   tendency:{bpa:0.5,posPrefs:['IOL','EDGE'],conf:'Big Ten',tradeUp:false}},
  {abbr:'PHI',name:'Philadelphia Eagles',color:'#004c54',needs:['OT','CB','EDGE','LB','S'],
   tendency:{bpa:0.4,posPrefs:['OT','CB'],conf:'SEC',tradeUp:true}},
  ...
  {abbr:'CHI',name:'Chicago Bears',color:'#0b162a',needs:['OT','WR','EDGE','DL','CB'],
   tendency:{bpa:0.5,posPrefs:['OT','EDGE'],conf:'ACC',tradeUp:false}},
  {abbr:'BUF',name:'Buffalo Bills',color:'#00338d',needs:['EDGE','CB','OT','WR','DL'],
   tendency:{bpa:0.6,posPrefs:['EDGE','CB'],conf:'SEC',tradeUp:false}},
  {abbr:'SF',name:'San Francisco 49ers',color:'#aa0000',needs:['WR','EDGE','OL','CB','S'],
   tendency:{bpa:0.5,posPrefs:['WR','EDGE'],conf:'Pac-12',tradeUp:false}},
  {abbr:'HOU',name:'Houston Texans',color:'#03202f',needs:['OT','EDGE','CB','DL','WR'],
   tendency:{bpa:0.5,posPrefs:['OT','EDGE'],conf:'Big 12',tradeUp:false}},
  {abbr:'LAR',name:'Los Angeles Rams',color:'#003594',needs:['WR','DB','CB','EDGE','OL'],
   tendency:{bpa:0.5,posPrefs:['WR','DB'],conf:'Pac-12',tradeUp:true}},
  {abbr:'DEN',name:'Denver Broncos',color:'#fb4f14',needs:['OT','EDGE','WR','CB','DL'],
   tendency:{bpa:0.5,posPrefs:['OT','EDGE'],conf:'Big 12',tradeUp:false}},
  {abbr:'NE',name:'New England Patriots',color:'#002244',needs:['CB','WR','OL','EDGE','DL'],
   tendency:{bpa:0.7,posPrefs:['CB','WR'],conf:'MWC',tradeUp:false}},
  {abbr:'SEA',name:'Seattle Seahawks',color:'#002244',needs:['DT','OL','EDGE','RB','CB','LB'],
   tendency:{bpa:0.5,posPrefs:['DT','OL'],conf:'ACC',tradeUp:false}},
];
...
{name:'Arvell Reese',pos:'EDGE',school:'Ohio State',grade:95,height:'6-4',weight:243,
 bio:'Reese is a fluid and explosive athlete Ohio State used as a chess piece. His 4.46 forty at the 2026 Combine featured the 6th best 10-yard split (1.58) all-time among edge rushers, confirming elite first-step explosion. He projects as a top-5 pass rusher with elite speed, bend and the ability to overpower blockers.',
 strengths:['Official 4.46 forty — 6th best 10-yd split all-time for EDGE','Versatile — plays multiple positions','Matches and mirrors TEs/RBs in coverage','Elite chase speed from the back side'],
 weaknesses:['Lacks a fully polished rush plan','Can be late off the snap','Still learning consistent leverage'],
 combine:{forty:4.46,bench:null,vert:null,broad:null,cone:null,shuttle:null,_status:'official'}},
...
{name:'Olaivavega Ioane',pos:'IOL',school:'Penn State',grade:92,height:'6-3',weight:315,
 ...
 combine:{forty:null,bench:null,vert:31.5,broad:104,cone:null,shuttle:null,_status:'official'}},
...
{name:'Jermod McCoy',pos:'CB',school:'Tennessee',grade:91,height:'6-0',weight:188,
 ...
 combine:{forty:null,bench:14,vert:null,broad:null,cone:null,shuttle:null,_status:'official'}},
...
{name:'Kenyon Sadiq',pos:'TE',school:'Oregon',grade:90,height:'6-2',weight:245,
 ...
 combine:{forty:4.39,bench:26,vert:43.5,broad:133,cone:null,shuttle:null,_status:'official'}},
...
{name:'Denzel Boston',pos:'WR',school:'Washington',grade:89,height:'6-3',weight:210,
 ...
 combine:{forty:null,bench:null,vert:35,broad:null,cone:null,shuttle:4.28,_status:'official'}},
{name:'Omar Cooper Jr.',pos:'WR',school:'Indiana',grade:89,height:'6-1',weight:200,
 ...
 combine:{forty:4.42,bench:null,vert:37,broad:null,cone:null,shuttle:null,_status:'official'}},
...
{name:'Cashius Howell',pos:'EDGE',school:'Texas A&M',grade:88,height:'6-2',weight:248,
 ...
 combine:{forty:4.59,bench:null,vert:32.5,broad:115,cone:null,shuttle:null,_status:'official'}},
...
{name:'Dillon Thieneman',pos:'S',school:'Oregon',grade:88,height:'6-1',weight:205,
 ...
 combine:{forty:4.35,bench:18,vert:41,broad:125,cone:null,shuttle:null,_status:'official'}},
{name:'Blake Miller',pos:'OT',school:'Clemson',grade:87,height:'6-6',weight:318,
 bio:'Miller is an iron man — 54 starts at RT. High school wrestler with ideal size, length and strength. His 5.04 forty at the 2026 Combine was below average for tackles but acceptable given his 6\'6", 317 lb frame. Latches and controls with strong hands. An anchor RT at the next level.',
 ...
 weaknesses:['5.04 forty — limited athleticism for LT consideration','Struggles to redirect in space','Limited left tackle upside'],
 combine:{forty:5.04,bench:null,vert:32,broad:113,cone:null,shuttle:null,_status:'official'}},
{name:'Monroe Freeling',pos:'OT',school:'Georgia',grade:87,height:'6-6',weight:310,
 ...
 combine:{forty:4.93,bench:null,vert:33.5,broad:115,cone:null,shuttle:null,_status:'official'}},
...
{name:'Lee Hunter',pos:'DT',school:'Texas Tech',grade:86,height:'6-2',weight:315,
 ...
 combine:{forty:5.18,bench:null,vert:21.5,broad:100,cone:null,shuttle:null,_status:'official'}},
...
{name:'Kadyn Proctor',pos:'OT',school:'Alabama',grade:86,height:'6-7',weight:335,
 ...
 combine:{forty:5.21,bench:null,vert:32.5,broad:109,cone:null,shuttle:null,_status:'official'}},
{name:'Avieon Terrell',pos:'CB',school:'Clemson',grade:85,height:'5-10',weight:185,
 ...
 combine:{forty:null,bench:17,vert:34,broad:123,cone:null,shuttle:null,_status:'official'}},
{name:'Caleb Lomu',pos:'OT',school:'Utah',grade:85,height:'6-6',weight:305,
 ...
 combine:{forty:4.99,bench:null,vert:32.5,broad:113,cone:null,shuttle:null,_status:'official'}},
...
{name:'Max Iheanachor',pos:'OT',school:'Arizona State',grade:84,height:'6-6',weight:320,
 ...
 combine:{forty:4.91,bench:null,vert:30.5,broad:115,cone:null,shuttle:null,_status:'official'}},
...
{name:'Brandon Cisse',pos:'CB',school:'South Carolina',grade:83,height:'6-1',weight:185,
 ...
 combine:{forty:null,bench:null,vert:41,broad:131,cone:null,shuttle:null,_status:'official'}},
...
{name:'Anthony Hill Jr.',pos:'LB',school:'Texas',grade:82,height:'6-2',weight:240,
 ...
 combine:{forty:4.51,bench:21,vert:37,broad:125,cone:null,shuttle:null,_status:'official'}},
{name:'Jadarian Price',pos:'RB',school:'Notre Dame',grade:81,height:'5-10',weight:210,
 ...
 combine:{forty:4.49,bench:21,vert:35,broad:124,cone:null,shuttle:null,_status:'official'}},
...
{name:'Antonio Williams',pos:'WR',school:'Clemson',grade:80,height:'5-10',weight:185,
 ...
 combine:{forty:4.41,bench:10,vert:39.5,broad:124,cone:7.00,shuttle:null,_status:'official'}},
...
{name:'Jake Golday',pos:'LB',school:'Cincinnati',grade:80,height:'6-3',weight:230,
 ...
 combine:{forty:4.62,bench:null,vert:39,broad:125,cone:7.02,shuttle:4.34,_status:'official'}},
{name:'Deion Burks',pos:'WR',school:'Oklahoma',grade:79,height:'5-11',weight:198,
 ...
 combine:{forty:4.30,bench:26,vert:42.5,broad:131,cone:null,shuttle:null,_status:'official'}},
...
{name:'LT Overton',pos:'DT',school:'Alabama',grade:85,height:'6-5',weight:278,
 ...
 combine:{forty:4.87,bench:null,vert:null,broad:null,cone:null,shuttle:null,_status:'official'}},
{name:'Emmanuel Pregnon',pos:'IOL',school:'Oregon',grade:84,height:'6-5',weight:318,
 ...
 combine:{forty:5.21,bench:null,vert:35,broad:111,cone:null,shuttle:null,_status:'official'}},
...
{name:'Kamari Ramsey',pos:'S',school:'USC',grade:83,height:'6-0',weight:205,
 ...
 combine:{forty:4.47,bench:16,vert:36,broad:120,cone:null,shuttle:null,_status:'official'}},
...
{name:'Gennings Dunker',pos:'OT',school:'Iowa',grade:82,height:'6-5',weight:315,
 ...
 combine:{forty:5.18,bench:null,vert:32.5,broad:108,cone:null,shuttle:4.63,_status:'official'}},
...
{name:'Germie Bernard',pos:'WR',school:'Alabama',grade:81,height:'6-1',weight:204,
 ...
 combine:{forty:4.48,bench:null,vert:32.5,broad:125,cone:6.71,shuttle:4.31,_status:'official'}},
...
{name:'Keith Abney II',pos:'CB',school:'Arizona State',grade:80,height:'6-0',weight:190,
 ...
 combine:{forty:null,bench:15,vert:null,broad:null,cone:null,shuttle:null,_status:'official'}},
...
{name:'Romello Height',pos:'EDGE',school:'Texas Tech',grade:79,height:'6-3',weight:240,
 ...
 combine:{forty:4.64,bench:null,vert:39,broad:125,cone:null,shuttle:null,_status:'official'}},
{name:'A.J. Haulcy',pos:'S',school:'LSU',grade:78,height:'6-0',weight:222,
 ...
 combine:{forty:4.52,bench:null,vert:null,broad:null,cone:null,shuttle:null,_status:'official'}},
...
{name:'Jonah Coleman',pos:'RB',school:'Washington',grade:76,height:'5-10',weight:215,
 ...
 combine:{forty:null,bench:22,vert:null,broad:null,cone:null,shuttle:null,_status:'official'}},
...
{name:'Treydan Stukes',pos:'DB',school:'Arizona',grade:82,height:'6-2',weight:195,
 bio:'Stukes is the ultimate chess piece — plays slot CB, boundary CB and free safety. Jeremiah has him going #29 overall to KC with a Trent McDuffie comp. Ran 4.33 at combine with a 38" vert and 130" broad. 7 career INTs. Some teams love him; he has been very impressive in pre-draft interviews.',
 strengths:['Official 4.33 forty — elite speed','Versatile — slot/boundary/free safety','Ball-hawking instincts — 7 career INTs','High football IQ and character'],
 weaknesses:['Older prospect — 24 years old','2024 ACL tear in medical history','Struggles vs twitchy WRs in press-man','Takes poor pursuit angles in run support'],
 combine:{forty:4.33,bench:null,vert:38,broad:130,cone:null,shuttle:null,_status:'official'}},
{name:'Chris Johnson',pos:'CB',school:'San Diego State',grade:80,height:'6-0',weight:193,
 bio:'Johnson is a hyperaware coverage specialist with instinctive eyes and fluid movement skills. Elite 2025 production: 92.4 PFF coverage grade, 16.1 passer rating allowed when targeted, 4 INTs (2 returned for TDs), 5 PBUs. Jeremiah projects him to the Patriots at #31.',
 strengths:['Elite 2025 ball production — 4 INTs, 2 pick-6s','92.4 PFF coverage grade','Instinctive and hyperaware','Versatile — can line up at multiple spots'],
 weaknesses:['Group of 5 level of competition','Run defense grade below average','Primarily a coverage specialist','Still adjusting to NFL-caliber receivers'],
 combine:{forty:4.48,bench:null,vert:37,broad:123,cone:null,shuttle:null,_status:'official'}},
];
